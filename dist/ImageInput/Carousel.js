...
export var MainCarousel = function (_a) {
    ...
    return (React.createElement(React.Fragment, null, images && images.length > 0 && is360 ? (React.cloneElement(children, {
        ...
        is360: is360,
    })) : (React.createElement(Swiper, { loop: true, spaceBetween: 0, navigation: images && (images === null || images === void 0 ? void 0 : images.length) > 1, thumbs: thumbs, className: "main-swiper" }, images && images.length > 0 ? (images.map(function (item, index) { return (React.createElement(SwiperSlide, { key: index }, React.cloneElement(children, {
